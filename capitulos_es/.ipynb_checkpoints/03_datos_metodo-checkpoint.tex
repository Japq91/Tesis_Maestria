...
Con el fin de evaluar si los patrones identificados cambian para sistemas más vigorosos y potencialmente más dañinos, se define un subconjunto de ciclones intensos basado en un criterio dinámico interno. Para cada ciclón en la base de datos, se extrae el valor mínimo de vorticidad relativa a 850 hPa ($\zeta_{850}^{min}$) a lo largo de todo su ciclo de vida. En el Hemisferio Sur, valores más negativos indican un vórtice más intenso. El subconjunto intenso se define como el 10\% superior de ciclones con los valores de $\zeta_{850}^{min}$ más negativos (cuartil superior). Este criterio de selección de extremos es consistente con estudios previos sobre ciclones intensos en la región \citep{reboita2010south}.
