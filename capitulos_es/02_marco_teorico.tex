...
El sector austral ($>40^\circ$S, RG3) responde a un régimen dinámico clásico dominado por la baroclinicidad de gran escala. A diferencia de los focos subtropicales, \citet{hoskins2005new} describen esta zona como gobernada por la inestabilidad baroclínica, donde la génesis depende del chorro polar y el paso de ondas de Rossby. Aquí, \citet{simmonds2000variability} indican que estos sistemas dependen menos de los forzantes locales de superficie y más de la dinámica de la alta troposfera. Los ciclos de vida son más lineales y rápidos en comparación con SBR \citep{vera2002cold}. 
%%$$$$$$
%%%%%%%% SECTION 4
%%$$$$$$
